...
async def awake(event):
  ...
  BUTTON = [[Button.url("ʜᴇʟᴘ​", "https://t.me/DionXRobot?start=help"), Button.url("sᴜᴘᴘᴏʀᴛ​", "https://t.me/DionXSupport")]]
